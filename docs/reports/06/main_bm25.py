...
def query_eeg_data(request: QueryRequest):
    try:
        ...
        # --- Final docs going to the LLM ---
        eeg_docs = eeg_fused_docs
        medical_docs = medical_fused_docs
        video_docs = video_fused_docs
        ...
        # Nothing came back from any source — return early
...
def health_check():
    return {
        "status": "healthy",
        "mode": "mac_air_3_source_bm25_rag",
        "collections": {
